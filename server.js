...
const API_BASE_URL = 'https://377-final-project-one.vercel.app/'; // Replace with your actual deployed backend URL
...
// Start the server
app.listen(PORT, () => {
    console.log(`BookExplorer is running at https://iycbbgybrnnxegoirtcp.supabase.co`);
});
